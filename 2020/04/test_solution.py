...
class VerifyBirthYearTests(TestCase):
    ...
    def test_min(self):
        self.assertEqual(
            solution.verify_birth_year("1920"),
            1920
        )
    
    def test_max(self):
        self.assertEqual(
            solution.verify_birth_year("2002"),
            2002
        )

    def test_mid_range(self):
        self.assertEqual(
            solution.verify_birth_year("1990"),
            1990
        )
...
class VerifyIssueYearTests(TestCase):
    ...
    def test_min(self):
        self.assertEqual(
            solution.verify_issue_year("2010"),
            2010
        )
    
    def test_max(self):
        self.assertEqual(
            solution.verify_issue_year("2020"),
            2020
        )

    def test_mid_range(self):
        self.assertEqual(
            solution.verify_issue_year("2015"),
            2015
        )
...
class VerifyExpirationYearTests(TestCase):
    ...
    def test_min(self):
        self.assertEqual(
            solution.verify_expiration_year("2020"),
            2020
        )
    
    def test_max(self):
        self.assertEqual(
            solution.verify_expiration_year("2030"),
            2030
        )

    def test_mid_range(self):
        self.assertEqual(
            solution.verify_expiration_year("2025"),
            2025
        )
...
class VerifyHeightTests(TestCase):
    ...
    def test_height_cm_min(self):
        self.assertEqual(
            solution.verify_height("150cm"),
            (150, "cm")
        )

    def test_height_cm_max(self):
        self.assertEqual(
            solution.verify_height("193cm"),
            (193, "cm")
        )

    def test_height_cm_mid(self):
        self.assertEqual(
            solution.verify_height("170cm"),
            (170, "cm")
        )

    def test_height_in_min(self):
        self.assertEqual(
            solution.verify_height("59in"),
            (59, "in")
        )

    def test_height_cm_max(self):
        self.assertEqual(
            solution.verify_height("76in"),
            (76, "in")
        )

    def test_height_cm_mid(self):
        self.assertEqual(
            solution.verify_height("60in"),
            (60, "in")
        )
...
class TestVerifyHairColor(TestCase):
    ...
    def test_valid_color(self):
        self.assertEqual(
            solution.verify_hair_color("#090a88"),
            "#090a88"
        )
